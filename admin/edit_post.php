...
if (isset($_POST['update_post'])) {
  ...
  echo "<p class='alert alert-success' role='alert'>Post editado com sucesso! <a href='../post.php?p_id={$the_post_id}'> Ver Post </a></p>";
}
?>
      ...
      <div class="row">
        ...
        <form action="" method="post" enctype="multipart/form-data" class="row">
          ...
          <div class="form-group">
            ...
            <input value="<?php echo $post_tag; ?>" type="text" class="form-control" name="post_tag" required>
          </div>
